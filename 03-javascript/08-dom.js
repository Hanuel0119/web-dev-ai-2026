...
// id로 가져오기
console.log(document.getElementsById("testId"));
...
editDiv.removeAttribute("date-test");

// 스타일 조작
editDiv.style.color = "orange";
editDiv.style.backgoundColor = "yellow";
...
console.log(div2.classList.contains("active")); // 해당
div2.classList.toggle("active");

// 문서 객체 추가.삭제
const textId3 = document.querySelector("#testId3");
...
// 3번째 문제
const colotBox = document.querySelector("#colorBox");
const changeColor = function() {
    colorBox.style.backgoundColor = "yellow";
};
...
function toggleClass() {
    // toggle 클래스가 포함 된 경우
    if (result9.classList.add("toggle")) {
        // 포함되지 않은 경우
